  ...
  config = function()
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(event)
        ...
        map("<leader>ljd", require("telescope.builtin").lsp_definitions, "[G]oto [D]efinition")

        -- Find references for the word under your cursor.
        map("<leader>ljr", require("telescope.builtin").lsp_references, "[G]oto [R]eferences")

        -- Jump to the implementation of the word under your cursor.
        --  Useful when your language has ways of declaring types without an actual implementation.
        map("<leader>lji", require("telescope.builtin").lsp_implementations, "[G]oto [I]mplementation")
        ...
        map("<leader>ljD", vim.lsp.buf.declaration, "[G]oto [D]eclaration")
